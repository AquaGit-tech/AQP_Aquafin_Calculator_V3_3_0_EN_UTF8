/* AQP Aquafin Calculator V3.3.0 (en) - service worker
   Offline-werking op de werf. navigate=network-first, assets=cache-first. */
var CACHE = 'aqp-aquafin-en-v3-3-0';
self.addEventListener('install', function(e) {
    e.waitUntil(caches.open(CACHE).then(function(c) {
        return c.addAll(['AQP_Aquafin_Calculator_V3_3_0_EN_UTF8.html']).catch(function() {});
